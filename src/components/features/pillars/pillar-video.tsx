...
/**
 * The pillar's teaching video on the detail page. Currently a click-to-YouTube
 * thumbnail (the channel's videos have embedding disabled, so an inline iframe
 * would show "Video unavailable"). If embedding is enabled later, swap the
 * outer <a> for the lazy-iframe pattern used by DailyShortCard.
 */
    ...
    <section className="vedic-card overflow-hidden">
      ...
      <div className="grid md:grid-cols-[1.4fr_1fr] gap-6 p-6">
        <a
          ...
          className="relative group block aspect-video rounded-xl overflow-hidden bg-gray-900"
        >
