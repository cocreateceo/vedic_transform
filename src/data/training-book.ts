...
export interface TrainingChapter {
   ...
   *  `section` weaves the piece inline after the matching section heading
   *  ("@lesson" / "@practices" / "@reflections" for the fixed blocks);
   *  unsectioned items collect in the end-of-chapter gallery. */
  gallery?: { src: string; title: string; section?: string }[];
  /** Teaching study cards — "learn from the image" poster frames. */
  studyCards?: { src: string; title: string; section?: string }[];
...
export const TRAINING_CHAPTERS: TrainingChapter[] = [
  {
    ...
    studyCards: [
      { src: "/training-media/posters/intro-sections/d1.webp", title: "Dimension 1 — Consciousness", section: "Five Dimensions of Evolution" },
      { src: "/training-media/posters/intro-sections/d2.webp", title: "Dimension 2 — Health & Energy", section: "Five Dimensions of Evolution" },
      { src: "/training-media/posters/intro-sections/d3.webp", title: "Dimension 3 — Relationships & Service", section: "Five Dimensions of Evolution" },
      { src: "/training-media/posters/intro-sections/d4.webp", title: "Dimension 4 — Leadership & Creation", section: "Five Dimensions of Evolution" },
      { src: "/training-media/posters/intro-sections/d5.webp", title: "Dimension 5 — Wealth & Purpose", section: "Five Dimensions of Evolution" },
      { src: "/training-media/posters/intro-sections/s_shift.webp", title: "A Profound Shift", section: "A Profound Shift" },
      { src: "/training-media/posters/intro-sections/s_future.webp", title: "The Future Is Conscious", section: "A Profound Shift" },
      { src: "/training-media/posters/intro-sections/s_mastering.webp", title: "Mastering the Modern World", section: "A Profound Shift" },
      { src: "/training-media/posters/intro-sections/s_combines.webp", title: "What the Journey Combines", section: "Five Dimensions of Evolution" },
      { src: "/training-media/posters/intro-sections/s_expansion.webp", title: "Aligned Expansion", section: "Five Dimensions of Evolution" },
      { src: "/training-media/posters/intro-sections/s_writtenfor.webp", title: "Who This Book Is For", section: "Who This Book Is For" },
    ],
  ...
  },
  {
    ...
    gallery: [
      { src: "/training-media/gallery/connect-to-the-universe/hanuman_ocean.webp", title: "Hanuman at the ocean's edge", section: "The Forgotten Power Within" },
      { src: "/training-media/gallery/connect-to-the-universe/hanuman_jambavan.webp", title: "Jambavan reminds Hanuman who he is", section: "The Forgotten Power Within" },
      { src: "/training-media/gallery/connect-to-the-universe/hanuman_rising.webp", title: "The remembering", section: "The Forgotten Power Within" },
      { src: "/training-media/gallery/connect-to-the-universe/hanuman_flight.webp", title: "The impossible crossing", section: "The Forgotten Power Within" },
      { src: "/training-media/gallery/connect-to-the-universe/arjuna_despair.webp", title: "Arjuna's crisis at Kurukshetra", section: "Arjuna’s Crisis" },
      { src: "/training-media/gallery/connect-to-the-universe/krishna_counsel.webp", title: "Krishna expands Arjuna's consciousness", section: "Arjuna’s Crisis" },
      { src: "/training-media/gallery/connect-to-the-universe/vishwaroopa.webp", title: "Vishwaroopa — the universal form", section: "Arjuna’s Crisis" },
      { src: "/training-media/gallery/connect-to-the-universe/arjuna_renewed.webp", title: "Clarity restored", section: "Arjuna’s Crisis" },
    ],
    studyCards: [
      { src: "/training-media/posters/ch01-cards/c1_overview.webp", title: "Chapter Overview", section: "@lesson" },
      { src: "/training-media/posters/ch01-cards/c1_hanuman.webp", title: "Hanuman Remembers", section: "The Forgotten Power Within" },
      { src: "/training-media/posters/ch01-cards/c1_whoami.webp", title: "Who Am I?", section: "The Central Question of Human Life" },
      { src: "/training-media/posters/ch01-cards/c1_wave.webp", title: "The Wave and the Ocean", section: "The Great Illusion of Separation" },
      { src: "/training-media/posters/ch01-cards/c1_arjuna.webp", title: "Arjuna's Crisis", section: "Arjuna’s Crisis" },
      { src: "/training-media/posters/ch01-cards/c1_energy.webp", title: "Energy & Frequency", section: "Energy and Frequency" },
      { src: "/training-media/posters/ch01-cards/c1_observer.webp", title: "The Observer Within", section: "The Central Question of Human Life" },
      { src: "/training-media/posters/ch01-cards/c1_nature.webp", title: "Nature as a Teacher", section: "Nature as a Teacher" },
      { src: "/training-media/posters/ch01-cards/c1_alignment.webp", title: "The Way of Alignment", section: "My Own Journey" },
      { src: "/training-media/posters/ch01-cards/c1_practices.webp", title: "The Practices", section: "@practices" },
      { src: "/training-media/posters/ch01-cards/c1_reflect.webp", title: "Reflection", section: "@reflections" },
      { src: "/training-media/posters/ch01-cards/c1_affirm.webp", title: "Affirmations", section: "@practices" },
    ],
  },
  {
    ...
    gallery: [
      { src: "/training-media/gallery/consciousness-and-self-awareness/arjuna_closeup.webp", title: "The warrior who could not fight", section: "The Warrior Who Could Not Fight" },
      { src: "/training-media/gallery/consciousness-and-self-awareness/arjuna_despair2.webp", title: "Overwhelmed at Kurukshetra", section: "The Warrior Who Could Not Fight" },
      { src: "/training-media/gallery/consciousness-and-self-awareness/chariot_metaphor.webp", title: "The chariot of life — Katha Upanishad", section: "The Chariot of Life" },
      { src: "/training-media/gallery/consciousness-and-self-awareness/chariot_wild.webp", title: "When the horses run wild", section: "The Chariot of Life" },
      { src: "/training-media/gallery/consciousness-and-self-awareness/chariot_aligned.webp", title: "The intellect takes the reins", section: "The Chariot of Life" },
      { src: "/training-media/gallery/consciousness-and-self-awareness/ego_masks.webp", title: "The ego's many masks", section: "The Ego’s Greatest Trick" },
      { src: "/training-media/gallery/consciousness-and-self-awareness/yudhishthira_storm.webp", title: "Yudhishthira — calm within the storm", section: "Yudhishthira and Emotional Stability" },
      { src: "/training-media/gallery/consciousness-and-self-awareness/mirror_reveal.webp", title: "The mirror principle", section: "The Mirror Principle" },
      { src: "/training-media/gallery/consciousness-and-self-awareness/doorway_inward.webp", title: "The doorway inward", section: "Developing Self-Awareness" },
    ],
    studyCards: [
      { src: "/training-media/posters/ch02-cards/c2_overview.webp", title: "Chapter Overview", section: "@lesson" },
      { src: "/training-media/posters/ch02-cards/c2_kurukshetra.webp", title: "The Battlefield Within", section: "The Warrior Who Could Not Fight" },
      { src: "/training-media/posters/ch02-cards/c2_observer.webp", title: "The Silent Witness", section: "What Is Consciousness?" },
      { src: "/training-media/posters/ch02-cards/c2_chariot.webp", title: "The Chariot of Life", section: "The Chariot of Life" },
      { src: "/training-media/posters/ch02-cards/c2_ego.webp", title: "The Ego's Greatest Trick", section: "The Ego’s Greatest Trick" },
      { src: "/training-media/posters/ch02-cards/c2_leadership.webp", title: "Conscious Leadership", section: "My Own Leadership Lessons" },
      { src: "/training-media/posters/ch02-cards/c2_yudhishthira.webp", title: "Emotional Stability", section: "Yudhishthira and Emotional Stability" },
      { src: "/training-media/posters/ch02-cards/c2_attention.webp", title: "Attention Is Energy", section: "The Modern Epidemic of Distraction" },
      { src: "/training-media/posters/ch02-cards/c2_mirror.webp", title: "The Mirror Principle", section: "The Mirror Principle" },
      { src: "/training-media/posters/ch02-cards/c2_meditation.webp", title: "Meditation for Self-Awareness", section: "Developing Self-Awareness" },
      { src: "/training-media/posters/ch02-cards/c2_practices.webp", title: "The Practices", section: "@practices" },
      { src: "/training-media/posters/ch02-cards/c2_reflect.webp", title: "Reflection", section: "@reflections" },
    ],
  },
  {
