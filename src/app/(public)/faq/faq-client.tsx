    ...
    <div className="text-[#1a1a1a]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-xl mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 rounded-xl bg-white border border-[#FF9933]/25 text-[#1a1a1a] placeholder-[#94a3b8] focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/30 transition-colors"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#FFF9F0]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 p-8 rounded-2xl bg-white border border-[#FF9933]/20 shadow-sm text-center">
